...
class CookiesPolicyView extends StatefulWidget {
  const CookiesPolicyView({super.key});

  @override
  State<CookiesPolicyView> createState() => _CookiesPolicyViewState();
}

class _CookiesPolicyViewState extends State<CookiesPolicyView> {
  @override
